...
namespace Zzy\Sociate;

use Zzy\Sociate\Exception\DriverNotSupportException;
use Zzy\Sociate\Exception\DriverNullException;
...
class Sociate
{
    ...
    {
        $className = 'Zzy\\Sociate\\Driver\\' . ucwords(strtolower($driver));
        $this->_driver = $driver;
